  ...
  return (
    <>
        ...
        <div className="overflow-hidden rounded-3xl border border-gold/20 bg-card shadow-soft">
          ...
          <div className="bg-gradient-festive px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-lg font-bold text-white leading-tight">Announcements</h3>
                <p className="text-[11px] text-white/75">Latest updates from school</p>
              </div>
            </div>
            <Link to="/notices" className="text-xs text-white/90 hover:text-white underline underline-offset-2">View all →</Link>
          </div>
          {/* Items */}
        ...
        <div className="overflow-hidden rounded-3xl border border-gold/20 bg-card shadow-soft">
          ...
          <div className="bg-gradient-peacock px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-lg font-bold text-white leading-tight">Upcoming Events</h3>
                <p className="text-[11px] text-white/75">Important dates ahead</p>
              </div>
            </div>
            <Link to="/calendar" className="text-xs text-white/90 hover:text-white underline underline-offset-2">Full calendar →</Link>
          </div>
          {/* Items */}
          <ul className="divide-y divide-gold/10">
              ...
              return (
                <li key={e.id} className="flex items-center gap-4 px-5 py-4 hover:bg-muted/30 transition-colors">
                  <div className="shrink-0 w-14 text-center rounded-xl border border-gold/20 bg-gradient-to-b from-primary/10 to-gold/10 py-2">
                    ...
                    <div className="text-[10px] uppercase tracking-widest text-muted-foreground mt-0.5">{d.toLocaleString("en-IN", { month: "short" })}</div>
                  </div>
                  <div className="flex-1 min-w-0">
      ...
      <section className="container-narrow mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { to: "/notices",    icon: FileText,    label: "Notices",       sub: "Circulars & updates",  color: "from-orange-500 to-red-500" },
          { to: "/fees",       icon: Wallet,      label: "Fee Structure", sub: "Class-wise fees",      color: "from-yellow-500 to-orange-500" },
          { to: "/calendar",   icon: CalendarDays,label: "Calendar",      sub: "Exams & events",       color: "from-teal-500 to-blue-600" },
          { to: "/admissions", icon: BookOpen,    label: "Admissions",    sub: "Apply for 2026–27",    color: "from-purple-500 to-pink-500" },
          ...
          >
            ...
            <div className="font-display font-semibold text-secondary text-sm">{label}</div>
              ...
              <div className="p-7">
                ...
                <div className="flex items-center gap-3 rounded-2xl border border-gold/20 bg-background/60 px-4 py-3">
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="font-display text-sm text-secondary whitespace-nowrap">{t.name}</span>
      ...
      <section className="container-narrow pb-10 md:pb-12">
        <div className="relative overflow-hidden rounded-3xl bg-[linear-gradient(135deg,hsl(22_88%_48%)_0%,hsl(38_95%_61%)_42%,hsl(43_95%_84%)_100%)] p-10 md:p-16 text-secondary shadow-temple ornate-frame">
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-xl">Admissions open for 2026–27. Walk through our gates and feel the heritage.</p>
